...
int main(int argc, char* argv[]) {
    ...
    unsigned char* data = stbi_load((texturePath + "container.jpg").c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    data = stbi_load((texturePath + "awesomeface.png").c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
